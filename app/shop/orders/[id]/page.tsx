...
export default function OrderDetailPage() {
  ...
  return (
    <main style={{ maxWidth: '600px', margin: '0 auto', padding: '40px 24px', display: 'flex', flexDirection: 'column', gap: '28px' }}>
      ...
      <div style={{ background: 'var(--surface)', border: '1px solid var(--border-card)', borderRadius: '14px', padding: '18px', display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: '12px' }}>
        ...
        <a
          ...
          style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '10px 18px', background: '#25d366', color: '#fff', borderRadius: '10px', textDecoration: 'none', fontWeight: 600, fontSize: '13px', fontFamily: 'var(--ff-body)', whiteSpace: 'nowrap', flexShrink: 0 }}
        >
